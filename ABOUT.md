# ApexSense — Technical Specs & FAQ

## What Is It?

ApexSense is a lightweight desktop HUD for iRacing that displays **real-time tire telemetry** and a **proximity radar** as transparent overlays on top of the game. It runs as a standalone Electron app alongside iRacing and reads telemetry data directly from the iRacing SDK.
